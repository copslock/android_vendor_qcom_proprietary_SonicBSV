...
ifneq (, $(filter $(PRODUCT_LIST), $(target_base_product)))
  ...
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_grease/target/product/qssi/prebuilt.mk)
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_HY11/target/product/qssi/prebuilt.mk)
  $(call inherit-product-if-exists, $(QC_PROP_ROOT)/prebuilt_HY22/target/product/qssi/prebuilt.mk)
...
# QSPM-hal components
QSPM_HAL := vendor.qti.qspmhal@1.0
