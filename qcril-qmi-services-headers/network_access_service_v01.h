...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2019 Qualcomm Technologies, Inc. All rights reserved.
  Confidential and Proprietary - Qualcomm Technologies, Inc.
  


  $Header: //commercial/MPSS.HI.1.0.r19/Main/modem_proc/qmimsgs/nas/api/network_access_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Jun  3 2019 (Spin 0)
...
#define NAS_V01_IDL_MINOR_VERS 0xF9
...
typedef struct {
  ...
  /**<  
      Type of signal strength. E.g RSSI, RSCP etc. \n
   */

  /*  Hysteresis */
  uint16_t delta;
  /**<  
      hysteresis value (in units of 0.1 dBm). \n
      Hysteresis value to be used for each signal \n
      For example, to set a hysteresis of 10 dBm, the value must be set 
      to 100. \n
      Value of 0 will disable the hysteresis for the signal strength type \n
      Hysteresis value defines the range by which the signal
 ...
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. wcdma_ecio_threshold_list, wcdma_rssi_threshold_list etc.) \n
      ...
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. wcdma_rscp_threshold_list, wcdma_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. wcdma_ecio_delta, wcdma_rssi_delta etc.)
 ...
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. gsm_rssi_threshold_list etc.) \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g. RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      ...
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. gsm_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. gsm_rssi_delta etc.) \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. \n
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. lte_rsrp_threshold_list, lte_rssi_threshold_list etc.) \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g. RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      ...
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. lte_rsrp_threshold_list, lte_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. lte_rsrp_delta, lte_rssi_delta etc.) \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. \n
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. tdscdma_rscp_threshold_list, tdscdma_rssi_threshold_list etc.) \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g. RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      If hysteresis value is set to 0, 
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. tdscdma_ecio_threshold_list, tdscdma_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. tdscdma_rscp_delta, tdscdma_rssi_delta etc.) \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. \n
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. cdma_ecio_threshold_list, cdma_rssi_threshold_list etc.) \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g. RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      ...
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. cdma_ecio_threshold_list, cdma_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. cdma_ecio_delta, cdma_rssi_delta etc.) \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. \n
 */
  ...
  /**<  
      ...
      Hysteresis TLV is used to create a hysteresis band around each threshold list value 
      (for.e.g. hdr_ecio_threshold_list, hdr_rssi_threshold_list etc.) \n
      Prevents multiple reports generation when the signal strength is close to a threshold value 
      and changing little \n
      So, the signal strength indicators (e.g. RSSI) should not just cross the threshold value
      but also cross by more than the hysteresis value\n
      ...
      then the signal strength notifying criteria would be just to cross the threshold 
      (for.e.g. hdr_ecio_threshold_list, hdr_rssi_threshold_list etc.), 
      or vary by delta (for.e.g. hdr_ecio_delta, hdr_rssi_delta etc.) \n
      Once configured, the hysteresis value for a signal strength type is retained,
      until explicitly reconfigured to 0 again. \n
 */
  ...
  /**<  
      Hysteresis timer (in units of milli seconds). \n
      ...
      Value of 0 will disable the hysteresis \n
