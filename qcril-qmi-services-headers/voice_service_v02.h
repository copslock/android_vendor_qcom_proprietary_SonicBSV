...
/* This file was generated with Tool version 6.14.7
   It was generated on: Mon May  6 2019 (Spin 0)
...
#define VOICE_V02_IDL_MINOR_VERS 0x71
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x0076
/**
    @}
  */
...
typedef enum {
  ...
  SUPS_MODE_TEMPORARY_V02 = 0x00,
  SUPS_MODE_PERMANENT_V02 = 0x01,
 ...
 */
  ...
  */
  ...
  /**<   Content type of the IP caller info
       Length range: 1 to 25.
  */
  ...
  /**<   IP caller info sent over SIP header
       ASN.1 PER encoded data
...
typedef struct {
  ...
  */
  ...
  /**<   This value sent by nw indicates that, the nw ended the unwanted robocall with SIP 607.
  */
...
typedef struct {
  ...
  */
  ...
  /**<   TIR Mode. Values: \n
      - SUPS_MODE_TEMPORARY (0x00) --
      - SUPS_MODE_PERMANENT (0x01) --
 */
...
typedef struct {
  ...
  */
  ...
  /**<   \n An emergency service category received from IMS when a call ends with cause code 380;
        refer to \hyperref[STD-24008]{3GPP TS 24.008} Table 10.5.135 for valid data.
  */

  /* Optional */
  /*  Array of MT Display Unwanted Missed Call Information** */
  ...
  /**<   \n The value of is_nw_end_unwanted_call flag, depends on the value of is_unwanted_call flag received, when the nw ends the MT call with SIP 607.
  */
 ...
 */
  ...
  */
  ...
  /**<   USSD error cause description received from the network. This text can contain
       up to 256 UTF-16 characters and it is not guaranteed to be NULL terminated.
       Range: 0 to 256.
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Indication Message; Informs clients about the IP caller info status. */
typedef struct {

  /* Mandatory */
  /*  Call ID */
  uint8_t call_id;
  /**<   Call ID of the IP Call.
  */
  ...
  /**<   caller info transmission status. Values: \n
       0 - FAILURE
	   1 - SUCCESS
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Manages all call-independent supplementary service of all call forwarding
             activation, deactivation, registration, and erasure. */
typedef struct {
  ...
  voice_service_enum_v02 voice_service;
  /**<   Service. Values: \n
      - VOICE_SERVICE_ACTIVATE (0x01) --
      - VOICE_SERVICE_DEACTIVATE (0x02) --
      - VOICE_SERVICE_REGISTER (0x03) --
      - VOICE_SERVICE_ERASE (0x04) --
 */
  ...
  /**<   service class; see Table @latexonly\ref{tbl:extServiceClass}@endlatexonly
       for more information.
       If this TLV is not present, then, if voice service is
       ACTIVATE: Activation request shall apply to all subscribed basic service groups.
                        against which all call forward is registered.
       ERASURE: Erasure request applies for all basic service groups for which all call forward operation is registered.
       REGISTER: Registration shall be performed for all subscribed basic service groups.
       DEACTIVATE: Deactivation request shall apply to all basic services for which all call forward is active.
   */
  ...
  /**<   Timer value in seconds.
            If this TLV is not present, then previous value set by the client
            or the network operator value applies
   */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Manages all call-independent supplementary service of all call forwarding
             activation, deactivation, registration, and erasure. */
typedef struct {
  ...
  uint8_t failure_cause_valid;  /**< Must be set to true if failure_cause is being passed */
  qmi_sups_errors_enum_v02 failure_cause;
  /**<   This TLV will be sent only if the results of the sub-operations are not available;
           if they are available, this will not be sent and the individual sub-operation result TLVs will be sent.
           Supplementary services failure cause;
       see @latexonly Table~\ref{tbl:endReasons}@endlatexonly for more information.
  */
