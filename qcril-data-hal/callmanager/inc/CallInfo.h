...
public:
  EmbmsInfo() = delete;
  virtual ~EmbmsInfo() = default;

  void insertSai(int32_t sai);
  void insertEarfcn(int32_t earfcn);
  void activateTmgi(bool activate, int32_t tmgi);

private:
  set<int32_t> saiList;
  set<int32_t> earfcnList;
  unordered_map<bool, int32_t> tmgis;
};
